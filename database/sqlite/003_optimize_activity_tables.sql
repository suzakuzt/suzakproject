...
CREATE TABLE IF NOT EXISTS user_daily_state (
  ...
  base_draw_chance INTEGER NOT NULL DEFAULT 1000 CHECK (base_draw_chance >= 0),
  ...
  remaining_draw_count INTEGER NOT NULL DEFAULT 1000 CHECK (remaining_draw_count >= 0),
